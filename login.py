...
def validar_telefone(telefone):
    return re.match(r'^\+[\d]{10,15}$', telefone)
...
class LoginCadastroApp:
    ...
    def criar_tela_cadastro(self):
        ...
        self.entry_telefone = ctk.CTkEntry(self.frame, placeholder_text="Telefone com DDI e DDD (ex: +5581999999999)", width=300)
    ...
    def muda_para_medalhas_py(self, nome_usuario):
        self.limpar_tela()  # limpa os widgets antigos
        OlympicMedalsViewer(self.root)  # carrega a nova interface na mesma janela
